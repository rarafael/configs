...
printf "\nInstalling packages...\n${NOCOLOR}" ; pacman -S --noconfirm --quiet --needed vim alacritty git zsh zsh-syntax-highlighting sway swaylock mako waybar ttf-joypixels ranger zathura zathura-pdf-mupdf sxiv mpv slurp ncdu xorg-xwayland p7zip dmenu wl-clipboard jq grim bashtop
mkdir "$HOME/Git"
