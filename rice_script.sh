...
printf "\nInstalling packages...\n${NOCOLOR}" ; pacman -S --noconfirm --quiet --needed vim alacritty git sway zsh zsh-syntax-highlighting sway swaylock mako waybar ttf-joypixels ranger zathura zathura-pdf-mupdf sxiv mpv slurp ncdu xorg-xwayland p7zip dmenu
