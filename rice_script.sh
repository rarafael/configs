...
printf "\nInstalling packages...\n${NOCOLOR}" ; pacman -S --noconfirm --quiet --needed vim alacritty git zsh zsh-syntax-highlighting sway swaylock dunst waybar ttf-joypixels ranger zathura zathura-pdf-mupdf sxiv mpv slurp ncdu xorg-xwayland dmenu wl-clipboard jq grim bashtop firefox steam discord pacman-contrib noto-fonts-cjk
mkdir -v "$HOME/Git"
